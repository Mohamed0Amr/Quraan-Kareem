...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AyaatState<T>);
}
...
/// @nodoc
class $AyaatStateCopyWith<T,$Res>  {
$AyaatStateCopyWith(AyaatState<T> _, $Res Function(AyaatState<T>) __);
}


/// Adds pattern-matching-related methods to [AyaatState].
extension AyaatStatePatterns<T> on AyaatState<T> {
...
class _Initial<T> implements AyaatState<T> {
  const _Initial();
...
class Loading<T> implements AyaatState<T> {
  const Loading();
...
class Success<T> implements AyaatState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of AyaatState
...
@override
String toString() {
  return 'AyaatState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AyaatStateCopyWith<T, $Res> {
...
class Error<T> implements AyaatState<T> {
...
@override
String toString() {
  return 'AyaatState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AyaatStateCopyWith<T, $Res> {
